  ...
  nftfi: {
    contract: {
      name:
        ...
        | 'v2-1.loan.fixed'
        | 'v2-3.loan.fixed'
        | 'v2.loan.fixed.collection'
        | 'v2-3.loan.fixed.collection'
    }
    fee: {
      bps: number | string
    }
...
export interface MetaStreetValuationSignedDto {
  quote: {
    /** @pattern ^0x[a-fA-F0-9]{40}$ */
    token: string
    /** @pattern ^[0-9]+$ */
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  nftfi = {
     ...
     * @tags NFTfi
     * @name CreateOffer
     * @request POST:/nftfi/{networkName}/{contractAddress}/offer/token/{tokenId}
     * @secure
     */
    createOffer: (
      tokenId: string,
  ...
  metaStreet = {
     ...
     * @request GET:/meta-street/{networkName}/{contractAddress}/{tokenId}/signed-valuation
     */
    getMetaStreetValuation: (
      ...
      networkName: NetworkName,
      query: {
        /** @example "Fabrica v3 Property Prices" */
        oracle: string
      },
      params: RequestParams = {},
    ) =>
      this.request<MetaStreetValuationSignedDto, any>({
        path: `/meta-street/${networkName}/${contractAddress}/${tokenId}/signed-valuation`,
        method: 'GET',
        query: query,
        format: 'json',
        ...params,

...
const fabricaEthereumHandler = new GraphqlHandler({
              ...
              config: {"endpoint":"https://subgraph.satsuma-prod.com/0f3e6e7bbd04/fabrica/fabrica-noipfs-ethereum/version/v0.0.8/api"},
              baseDir,
              cache,
              pubsub,
...
const fabricaSepoliaHandler = new GraphqlHandler({
              ...
              config: {"endpoint":"https://subgraph.satsuma-prod.com/0f3e6e7bbd04/fabrica/fabrica-noipfs-sepolia/version/v0.0.19/api"},
              baseDir,
              cache,
              pubsub,
